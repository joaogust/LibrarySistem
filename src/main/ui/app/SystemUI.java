...
public class SystemUI {
    ...
    public void cadastrarEmprestimo() {
        ...
        DefaultListModel<Livro> modelLivros = new DefaultListModel<>();
        for (Livro l : livros.getLivros()) {
            modelLivros.addElement(l);
        }

        JList<Livro> listaLivros = new JList<>(modelLivros);
        ...
        botaoConfirmar.addActionListener(e -> {
            ...
            java.util.List<Livro> livrosSelecionados = listaLivros.getSelectedValuesList();
            ...
            try {
                ...
                Emprestimo novoEmprestimo =
                        EmprestimoFactory.criarEmprestimo(
